  ...
  items: [
    {
      id: 'deepfake',
      title: '딥페이크 탐지',
      description: '합성·조작된 이미지를 식별하고 실제 촬영 여부를 판단합니다.'
    },
    {
      id: 'generation',
      title: '생성 모델 식별',
    ...
    },
    {
      id: 'document',
      title: '문서 위변조 탐지',
      description: 'PDF·텍스트의 AI 작성 여부와 편집 이력을 분석합니다.'
    },
    {
      id: 'llm',
      title: 'LLM 생성 텍스트',
      description: 'ChatGPT, Claude 등 LLM이 작성한 텍스트를 식별합니다.'
    }
  ]
};
  ...
  items: [
    {
      id: 'realtime',
      title: '실시간 검사',
      description: '업로드 즉시 분석이 시작되어 빠른 결과를 확인할 수 있습니다.'
    },
    {
      id: 'multiformat',
      title: '멀티포맷 지원',
      description: '이미지, 음성, 문서 각각에 최적화된 포맷을 지원합니다.'
    },
    {
      id: 'report',
      title: '상세 리포트',
      description: '신뢰도 점수와 분석 근거를 포함한 상세 결과를 제공합니다.'
    },
    {
      id: 'api',
      title: 'API 연동',
      description: 'REST API로 서비스·워크플로우에 쉽게 통합할 수 있습니다.'
    }
  ],
  ...
  steps: [
    {
      step: 1,
      title: '파일 업로드',
      description: '검사할 이미지, 음성, 문서를 업로드합니다.'
    },
    {
      step: 2,
      title: '분석 진행',
      description: '다중 엔진이 동시에 분석하여 정확한 판별을 수행합니다.'
    },
    {
      step: 3,
      title: '결과 도출',
      description: 'AI 생성 확률과 신뢰도를 점수로 제공합니다.'
    },
    {
      step: 4,
      title: '리포트 확인',
      description: '상세 분석 결과와 근거를 확인할 수 있습니다.'
    }
  ]
};
