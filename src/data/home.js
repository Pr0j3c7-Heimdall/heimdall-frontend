...
export const introData = {
  title: 'Heimdall이란?',
  description:
    'Heimdall은 이미지, 음성의 AI 생성 여부를 판별하는 검증 서비스입니다. 딥러닝 기반 모델로 신뢰할 수 있는 결과를 제공하며, API와 웹 인터페이스를 통해 쉽게 활용할 수 있습니다.',
  points: ['이미지: JPEG, PNG 등 주요 포맷 지원', '음성: MP3, WAV 등 오디오 파일 분석']
};
...
export const analysisData = {
  title: '탐지 & 분석 메커니즘',
  description: '다양한 분석 기법을 통해 이미지, 음성의 AI 생성 여부를 신뢰성 있게 판별합니다.',
  items: [
...
export const featuresData = {
  ...
  items: [
    ...
    { id: 'multiformat', icon: 'grid', title: '멀티포맷 지원', description: '이미지, 음성 각각에 최적화된 포맷을 지원합니다.' },
  ...
  formatChips: ['JPG', 'PNG', 'WebP', 'MP3', 'WAV', 'M4A']
};
