  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        'SSL-AASIST, RawNet3, CQCC+SSL+AASIST 기반 다중 관점 위조 탐지로 일반 음성 판별',
        'AASIST, RawNet3, LCNN 기반 보컬 질감·주파수·시간 패턴 분석으로 가창 음성 판별',
        '음성 메타데이터 및 오디오 속성 정보 추출',
        'Logistic Regression 기반 최종 AI 생성 여부 판정'
      ]
    },
    {
      name: '인프라',
