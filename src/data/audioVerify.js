export const audioAnalysisMethodsData = {
  ...
  items: [
    { id: 'voice-synth', icon: 'mic', title: '음성 합성 탐지', description: 'TTS, 보이스 클로닝 등 AI가 생성한 음성을 실시간으로 구분합니다.' },
    { id: 'spectrum', icon: 'chart', title: '스펙트럼 분석', description: '주파수 특성을 분석하여 자연 음성과 합성 음성의 차이를 탐지합니다.' },
