...
const cspHeader = `
    ...
    img-src 'self' blob: data: https://www.googletagmanager.com https://flagcdn.com https://*.openstreetmap.org https://*.clarity.ms https://*.bing.com https://lh3.googleusercontent.com https://heimdall.ai.kr;
