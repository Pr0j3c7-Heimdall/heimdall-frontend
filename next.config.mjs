...
const cspHeader = `
    ...
    connect-src 'self' http://localhost:8000 ${apiBaseUrl} https://www.googletagmanager.com https://accounts.google.com https://raw.githubusercontent.com https://phpstack-207002-5085356.cloudwaysapps.com https://*.clarity.ms https://*.azurewebsites.net;
`;
